...
<section id="inner_pages">
	<div class="container">
    	<div class="listing_header">
        	<h5>List of Theaters</h5>
            <form action="filter-info.php" method="post">
             ...
             if(isset($_POST['search']))
            {
                ...
                $query = "SELECT * FROM `theater` WHERE CONCAT(`theater_name`,`theater_location`, `theater_url`, `rating`) LIKE '%".$valueToSearch."%'";
                $search_result = filterTable($query);
                
            }
             else {
                $query = "SELECT * FROM `theater`";//Enter Table name here
                $search_result = filterTable($query);
            }
            ...
            <div class="listing_wrap">
                    ...
                    <div class="listing_info">
                        <div class="post_category">
                            <a href="#"><?php echo $row['theater_name']; ?></a>
                        </div>
                       
                        <p> <?php echo $row['theater_location']; ?></p>
                        <a href="<?php echo $row['mall_url']; ?>"><?php echo $row['theater_url']; ?></a>
