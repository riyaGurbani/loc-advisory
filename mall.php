	...
	<div class="container">
    	<div class="listing_header">
             ...
             if(isset($_POST['search']))
            {
                ...
                $query = "SELECT * FROM `malls` WHERE CONCAT(`mall_namae`, 'mall_id', `mall_address`, `mall_url`, `rating`) LIKE '%".$valueToSearch."%'";
                $search_result = filterTable($query);
                
            }
             else {
                $query = "SELECT * FROM `malls`";//Enter Table name here
                $search_result = filterTable($query);
            }
            ...
            <div class="listing_wrap">
                    ...
                    <div class="listing_info">
                        <div class="post_category">
                            <a href="#"><?php echo $row['mall_name']; ?></a>
                        </div>
                       
                        <p> <?php echo $row['mall_address']; ?></p>
                        <a href="<?php echo $row['mall_url']; ?>"><?php echo $row['mall_url']; ?></a>
