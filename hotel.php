	...
	<div class="container">
    	<div class="listing_header">
             ...
             if(isset($_POST['search']))
            {
                ...
                $query = "SELECT * FROM `hotels` WHERE CONCAT(`hotel_name`,`hotel_address`, `hotel_url`, `rate`) LIKE '%".$valueToSearch."%'";
                $search_result = filterTable($query);
                
            }
             else {
                $query = "SELECT * FROM `hotels`";//Enter Table name here
                $search_result = filterTable($query);
            }
            ...
            <div class="listing_wrap">
                    ...
                    <div class="listing_info">
                        <div class="post_category">
                            <a href="#"><?php echo $row['hotel_name']; ?></a>
                        </div>
                       
                        <p> <?php echo $row['hotel_address']; ?></p>
                        <a href="<?php echo $row['mall_url']; ?>"><?php echo $row['hotel_url']; ?></a>
                        <div class="listing_review_info">
                            <p><span class="review_score"><?php echo $row['rate']; ?></span> 
