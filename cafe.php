...
<div class="col-md-9 col-sm-12 col-xs-12">
          <div class="collapse navbar-collapse" id="navigation">
            ...
            <!--  <li class="menu-item-has-children"><a href="index.php">Home</a> <span class="arrow"></span>
             	<ul class="sub-menu">
              ...
              <li class="menu-item-has-children"><a href="#">Show By</a> <span class="arrow"></span>
              	 <ul class="sub-menu">
                     ...
                     <li class="menu-item-has-children"><a href="tour.php">Tourism</a> <span class="arrow"></span> </li>      </ul>
 <!--    	                <ul class="sub-menu">
	...
	<div class="container">
    	<div class="listing_header">
             ...
             if(isset($_POST['search']))
            {
                ...
                $query = "SELECT * FROM `cafe` WHERE CONCAT(`cafe_name`, `cafe_id`, `cafe_address`, `cafe_url`, `rating`) LIKE '%".$valueToSearch."%'";
                $search_result = filterTable($query);
                
            }
             else {
                $query = "SELECT * FROM `cafe`";//Enter Table name here
                $search_result = filterTable($query);
            }
            ...
            <div class="listing_wrap">
                    ...
                    <div class="listing_info">
                        <div class="post_category">
                            <a href="#"><?php echo $row['cafe_name']; ?></a>
                        </div>
                       
                        <p> <?php echo $row['cafe_address']; ?></p>
                        <p>Cost for two = <?php echo $row['cafe_estimate_price']; ?> </p>
                        <a href="<?php echo $row['cafe_url']; ?>"><?php echo $row['cafe_url']; ?></a>
